 ...
 * coin n can be exchanged in a bank into three coins: n/2, n/3 and
 * n/4. But these numbers are all rounded down (the banks have to make
 * a profit).
 *
 ...
 * $6+$4+$3 = $13. If you try changing the coin 2 into 3 smaller
 * coins, you will get 1, 0 and 0, and later you can get no more than
 * $1 out of them. It is better just to change the 2 coin directly
 * into $2.
 * */
#include<cstdio>
#define MAX 1000001
